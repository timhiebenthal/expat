...
with config_tab:
    st.text("Add cities or Jobs to the configuration file and update the pipeline afterwards to take changes into account.")
    ...
    col1.button("Save Changes", type="primary", on_click=utils.save_config, args=(cities, jobs), help="Overwrites the configuration file with the current values.")
    col2.button("Update Pipeline", type="primary", on_click=utils.run_pipeline, help="Runs the data pipeline to take modifications into account.")
